...
export default function CategoryHeader({ title = 'DestinAsian', menuItems }) {
...
58 -26 13 -340 13 -364 -1z"
          ...
          <NavigationMenu
            ...
            menuItems={menuItems}
          >
            <div className="flex h-12 flex-row px-2 py-0">
...
210 215 210 3 0 195 -190 427 -422z"
            ...
            <div className="flex h-12 flex-col px-2 py-0">
              {searchResultsError && (
